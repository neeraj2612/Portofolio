...
import PeepImage from '../../images/peeps-avatar (1).png';
    ...
    <section
      ...
      <div className="pb-20 md:max-w-screen-md md:mx-auto lg:max-w-[69.375rem]">
        <div className={`container relative ${cx(styles.container)}`}>
          ...
          <img
            className={`z-10 ${cx(styles.PeepImage)}`}
            src={
          ...
          <a href='/'>  <p className="text-white text-2xl font-bold md:text-3xl lg:text-[2rem]">
              Niraj saini
            </p>
            </a>
...
Niraj saini                </span>
            ...
            <div className="pt-[2.938rem] text-[1.125rem] leading-[1.75rem] text-portfolio-grey text-left font-medium">
              <p>Based in New Delhi, I&apos;m a front-end developer</p>
